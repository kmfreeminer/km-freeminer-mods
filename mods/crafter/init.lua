        ...
        if data.items[p]:get_name() == c.recipe[1][1] then
            ...
            for m=1,c._h do
                for n=1,c._w do
                    ...
                    print("  Checking data.items["..dump(i+m-1).."]["..dump(j+n-1).."]("..dump(q)..")="..
                    dump(data.items[q]:get_name())..
                    " vs craft.recipe["..dump(m).."]["..dump(n).."]="..
                    dump(c.recipe[m][n]))
...
function crafter.register_craft(craft)
    ...
    then
        minetest.log("action","registerCraft ("..craft.type..", output="..craft.output.." recipe="..dump(craft.recipe))
